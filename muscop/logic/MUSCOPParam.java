...
public class MUSCOPParam {
	...
	public static AtomicInteger[] indexMaster;
	public static AtomicBoolean[] alive;
	...
	public static final int MASTER_CHANGE_TTL = 5000;
	public static final int MASTER_MESSAGE_WAIT_TTL = 2000;
}
